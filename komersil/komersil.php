...
$query = mysqli_query($mysqli, "SELECT * from tb_komersil1");
?>
	...
	<section class="ftco-section">
		...
		<div class="container">
			...
			<div class="container-fluid">
				<h6 style="margin-top: 5% ;"> Data Product :</h6>
				<a href="create_komersil.php">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><?php echo $result['biaya_surat']; ?></td>
								<td><?php echo $result['total_bayar']; ?></td>
								<td>
									<div class="btn-group" role="group" aria-label="Basic mixed styles example">
										<a href="edit_komersil.php?id=<?php echo $result['id'] ?>">
